...
final class GpsTransport implements TransportInterface
{
    ...
    public function getReceiver(): GpsReceiver
    {
        ...
        $this->receiver = new GpsReceiver(
            $this->pubSubClient, $this->gpsConfiguration, $this->serializer, $this->logger
        );
    ...
    public function setup(): void
    {
        ...
        if (false === $topic->exists() && $this->gpsConfiguration->createTopicIfNotExist()) {
        ...
        if (false === $subscription->exists() && $this->gpsConfiguration->createSubscriptionIfNotExist()) {
            $topic->subscribe(
